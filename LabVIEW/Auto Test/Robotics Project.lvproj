...
<Project Type="Project" LVVersion="14008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="terminate_check (SubVI).vi" Type="VI" URL="../terminate_check (SubVI).vi"/>
		<Item Name="car_motion_control (SubVI).vi" Type="VI" URL="../car_motion_control (SubVI).vi"/>
		<Item Name="measurement_plot (SubVI).vi" Type="VI" URL="../measurement_plot (SubVI).vi"/>
		<Item Name="record time (SubVI).vi" Type="VI" URL="../record time (SubVI).vi"/>
		<Item Name="remote_calculation (SubVI).vi" Type="VI" URL="../remote_calculation (SubVI).vi"/>
		<Item Name="robot_initialize (SubVI).vi" Type="VI" URL="../robot_initialize (SubVI).vi"/>
